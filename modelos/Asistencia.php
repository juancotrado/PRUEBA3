...
public function registrar_salida($codigo_persona,$tipo,$detalles,$evidencia){
	date_default_timezone_set('America/Lima');
	$fecha = date("Y-m-d");
	$hora = date("H:i:s");
 	$sql = "INSERT INTO asistencia (codigo_persona,  tipo, fecha, detalles, evidencia) VALUES ('$codigo_persona', '$tipo', '$fecha', '$detalles', '$evidencia')";
    return ejecutarConsulta($sql);
}
