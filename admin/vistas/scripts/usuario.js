...
function init(){
  ...
  // $("#imagenmuestra").hide();
   ...
   /*$.post("../ajax/usuario.php?op=selectDepartamento", function(r){
   	$("#iddepartamento").html(r);
   	$('#iddepartamento').selectpicker('refresh'); 
   });*/

   /*$.post("../ajax/usuario.php?op=selectCat", function(r){
	$("#idcat").html(r);
	$('#idcat').selectpicker('refresh'); 
	});
	
*/
	$.ajax({
    type: 'POST',
    url: '../ajax/usuario.php?op=selectDepartamento'
  })
  .done(function(listas_rep){
    $('#iddepartamento').html(listas_rep)
  })
  .fail(function(){
	...
	$('#iddepartamento').on('change', function(){
		...
		$.ajax({
		  type: 'POST',
		  url: '../ajax/usuario.php?op=selectCat',
		  data: {'idusuario': id}
		})
		.done(function(asd){
			$('#idcat').html(asd)
   ...
   $.post("../ajax/cargo.php?op=selectCargos", function(r){
	$("#idcargo").html(r);
...
function mostrar(idusuario){
	$.post("../ajax/usuario.php?op=mostrar",{idusuario : idusuario},
		function(data,status)
		{
            ...
            $("#idcargo").selectpicker('refresh');
			$("#tipdepersonal").val(data.tipdepersonal);
			$("#grupocupacioonal").val(data.grupocupacional);
